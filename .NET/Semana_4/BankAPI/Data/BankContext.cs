    ...
    public partial class BankContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Account>(entity =>
            {
                ...
                entity.Property(e => e.Balence).HasColumnType("decimal(10, 2)");
                ...
                entity.HasOne(d => d.Client)
                    ...
                    .HasConstraintName("FK__Account__ClientI__403A8C7D");
            });
            ...
            modelBuilder.Entity<BankTransaction>(entity =>
            {
                ...
                entity.HasOne(d => d.Account)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__BankTrans__Accou__440B1D61");

                entity.HasOne(d => d.TransactionTypeNavigation)
                    .WithMany(p => p.BankTransactions)
                    .HasForeignKey(d => d.TransactionType)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__BankTrans__Trans__44FF419A");
            });
